...
# - (Optionally) install Maxine "features" (models/libs) via the SDK's install_feature.sh scripts
...
Options:
  ...
  --afx-tar PATH        Path to Audio_Effects_SDK.tar.gz (optional, audio not in MVP)
