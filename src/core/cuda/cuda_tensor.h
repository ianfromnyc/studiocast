...
struct CudaTensor {
  ...
  std::size_t pitch = 0;  // bytes between rows in the underlying allocation (Height=1)
  ...
  bool AllocateNchwF32(studiocast::maxine::CudaDriverApi* cuda,
                       int n_in,
                       int c_in,
                       int h_in,
                       int w_in,
  ...
  bool ReallocIfNeededNchwF32(studiocast::maxine::CudaDriverApi* cuda,
                              int n_in,
                              int c_in,
                              int h_in,
                              int w_in,
