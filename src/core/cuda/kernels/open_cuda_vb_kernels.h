...
bool ResizeBilinearF32_1(const CudaImage& src,
                         const CudaImage& dst,
...
bool BoxBlurSeparableU8x3(const CudaImage& src,
                          const CudaImage& tmp,
                          const CudaImage& dst,
                          int radius,
                          studiocast::maxine::CUstream stream,
...
bool BoxBlurSeparableF32_1(const CudaImage& src,
                           const CudaImage& tmp,
                           const CudaImage& dst,
                           int radius,
                           studiocast::maxine::CUstream stream,
...
bool CompositeAlphaU8x3(const CudaImage& fg,
                        const CudaImage& bg,
                        const CudaImage& alpha,
                        const CudaImage& out,
                        studiocast::maxine::CUstream stream,
                        std::string* error_out);

// out = alpha * fg + (1 - alpha) * solid_color
bool CompositeAlphaSolidU8x3(const CudaImage& fg,
                             const CudaImage& alpha,
                             std::uint8_t bg_r,
                             std::uint8_t bg_g,
                             std::uint8_t bg_b,
