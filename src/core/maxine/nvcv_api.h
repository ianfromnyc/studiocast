...
public:
  ...
  using NvCVImage_Realloc_t = NvCV_Status (*)(
  ...
  using NvCVImage_CompositeOverConstant_t =
      NvCV_Status (*)(const NvCVImage *src, const NvCVImage *mat,
                      const void *bgColor, NvCVImage *dst, CUstream stream);
