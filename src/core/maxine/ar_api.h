...
class ArApi {
public:
  using NvAR_Create_t = NvCV_Status (*)(NvAR_FeatureID featureID,
  ...
  using NvAR_SetU32_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                        NvAR_ParameterSelector param,
                                        uint32_t val);
  using NvAR_SetS32_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                        NvAR_ParameterSelector param,
                                        int32_t val);
  using NvAR_SetF32_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                        NvAR_ParameterSelector param,
                                        float val);
  using NvAR_SetF64_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                        NvAR_ParameterSelector param,
                                        double val);
  using NvAR_SetU64_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                        NvAR_ParameterSelector param,
                                        uint64_t val);
  using NvAR_SetString_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                           NvAR_ParameterSelector param,
                                           const char *str);
  using NvAR_SetObject_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                           NvAR_ParameterSelector param,
                                           void *ptr, unsigned long typeSize);
  using NvAR_SetF32Array_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                             const char *name, float *vals,
                                             int count);

  using NvAR_GetU32_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                        NvAR_ParameterSelector param,
                                        uint32_t *val);
  using NvAR_GetS32_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                        NvAR_ParameterSelector param,
                                        int32_t *val);
  using NvAR_GetF32_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                        NvAR_ParameterSelector param,
                                        float *val);
  using NvAR_GetF64_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                        NvAR_ParameterSelector param,
                                        double *val);
  using NvAR_GetU64_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                        NvAR_ParameterSelector param,
                                        uint64_t *val);
  using NvAR_GetString_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                           NvAR_ParameterSelector param,
                                           const char **str);
  ...
  using NvAR_SetCudaStream_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                               NvAR_ParameterSelector param,
                                               CUstream stream);
  using NvAR_GetCudaStream_t = NvCV_Status (*)(NvAR_FeatureHandle handle,
                                               NvAR_ParameterSelector param,
                                               CUstream *stream);
