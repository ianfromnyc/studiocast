...
class AfxApi {
public:
  using NvAFX_CreateEffect_t = NvAFX_Status (*)(NvAFX_EffectSelector effect,
                                                NvAFX_Handle *handle);
  using NvAFX_DestroyEffect_t = NvAFX_Status (*)(NvAFX_Handle handle);

  using NvAFX_SetU32_t = NvAFX_Status (*)(NvAFX_Handle handle,
  ...
  using NvAFX_SetU32List_t = NvAFX_Status (*)(NvAFX_Handle handle,
                                              ...
                                              std::uint32_t count);
  using NvAFX_SetFloat_t = NvAFX_Status (*)(NvAFX_Handle handle,
                                            NvAFX_ParameterSelector param,
                                            float val);
  using NvAFX_SetString_t = NvAFX_Status (*)(NvAFX_Handle handle,
                                             NvAFX_ParameterSelector param,
                                             const char *str);

  using NvAFX_GetU32_t = NvAFX_Status (*)(NvAFX_Handle handle,
                                          NvAFX_ParameterSelector param,
                                          std::uint32_t *val);
